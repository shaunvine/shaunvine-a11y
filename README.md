...
1. Run "ngrok http 8000" in a separate terminal window so it stays running.
2. Update the Contentful webhook with the url generated from running "ngrok http 8000"
