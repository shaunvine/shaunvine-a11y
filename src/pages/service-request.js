        ...
        <section className="service-request-page">
          <article className="service-request-info">
            ...
            <p className="service-request-intro">
              Whether you need expert QA testing or CMS content management, I
              am here to help. Fill out the form below with a few project
              details so I can better understand your goals and needs. Once
              submitted, I'll review everything and follow up within 1–2
              business days to schedule next steps.
            </p>
            <div>Thanks,</div>
            <div>Shaun</div>
          </article>
...
export const Head = ({ location }) => (
  <SEOmeta
    title="Service Request | Shaun Vine"
    description="Start your QA testing or CMS project with Shaun Vine. Fill out the project form and receive a response within 1–2 business days."
