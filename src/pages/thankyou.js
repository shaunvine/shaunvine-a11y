  ...
  return (
    <Layout>
      <SEOmeta
        ...
        description="Thank you for contacting me. Your form has been successfully sent. I generally answer within one business day."
      ...
      <main className="page">
        <section className="thankyou-page">
          <div>
            ...
            <p>I generally answer within one business day.</p>
          </div>
        </section>
        <section>
          <OutdoorImages />
