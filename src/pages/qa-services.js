              ...
              <span>
                <ul className="qa-custom-indent">
                  ...
                  <li>
                    <FaCheck className="included-check" />
                    <strong>
                      Pre-launch checks and post-update validation
                    </strong>
                    <ul>
                      <li>
              ...
              <span>
                <ul className="qa-custom-indent">
                  <li>
                    ...
                    <ul>
                      <li>
                        Your website is reviewed against accessibility
                        guidelines to ensure it’s inclusive and meets industry
                  ...
                  <li>
                    ...
                    <ul>
                      <li>
                        ...
                        formatting, and broken links to ensure a seamless
                        end-user experience.
                      </li>
                    </ul>
                  </li>
              ...
              <span>
                <ul className="qa-custom-indent">
                  ...
                  <li>
                    ...
                    <ul>
                      <li>
                        <h5>Custom quotes provided after a project review.</h5>
                      </li>
                    </ul>
                  </li>
                </ul>
